# Содержание
- [Отчет по настройке среды через Ansible](#отчет-по-настройке-среды-через-ansible)
	- [Описание рабочей среды](#описание-рабочей-среды)
	- [Ход работы](#ход-работы)
- [Описание Dockerfile со средой Ansible](#описание-dockerfile-со-средой-ansible)
